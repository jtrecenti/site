...
html_code <- '<div class="sourceCode" id="cb{language}"><pre class="sourceCode markdown code-with-copy"><code class="sourceCode markdown"><span id="cb{language}-1"><a href="http://localhost:4017/cv.html#cb{language}-1" aria-hidden="true" tabindex="-1"></a>{stringr::str_wrap(mini_cv, 40)}</span></code></pre></div>'
...
[![](profile_cv.jpg){width=30%}](./profile_cv.jpg){target="_blank"}
